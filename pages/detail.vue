		    ...
		    <div class="infos">
		      <div class="newsview">
		        ...
		        <div class="news_infos">
		          ...
		          <p><img src="../assets/images/v1.jpg"></p>
		          ...
		          <p><img src="../assets/images/v2.jpg"></p>
...
.au01 { background: url(../assets/images/author2.png) no-repeat left center }
.au02 { background: url(../assets/images/date.png) no-repeat left center }
...
.otherlink h2 { border-bottom: #000 2px solid; line-height: 40px; font-size: 14px; background: url(../assets/images/5794.png) left 10px center no-repeat; padding-left: 40px; color: #000 }
.otherlink ul { margin: 10px 0; overflow:hidden; padding:0 20px }
.otherlink li { line-height: 24px; height: 24px; display: block; width: 40%; float:left; overflow: hidden; padding-left: 10px; background:url(../assets/images/navline.jpg) no-repeat left center }
.otherlink li a:hover { text-decoration: underline; color: #000 }

.news_pl { margin: 10px 0; width: 100%; background: #FFF; overflow: hidden; margin: 20px 0 }
.news_pl h2 { background: url(../assets/images/newsbg03.png) no-repeat left 10px center; border-bottom: #000 2px solid; line-height: 40px; font-size: 14px; padding-left: 30px; color: #000 }
