<template>
    <div class="banner">
    <div id="sucaihuo" class="fader"> <img class="slide" src="../assets/images/banner01.jpg"> <img class="slide" src="../assets/images/banner02.jpg"> <img class="slide" src="../assets/images/banner03.jpg">
